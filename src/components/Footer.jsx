    ...
    <footer className="footer">
      <div className="footer-top">
        <div className="footer-brand">
          <Link to="/" className="footer-logo">ProjectEurasia</Link>
        ...
        <div className="footer-contact">
          <h4>Contact</h4>
          <ul>
            <li><i className="fas fa-envelope"></i> info@projecteurasia.com</li>
            <li><i className="fas fa-phone"></i> +1 (234) 567-8900</li>
            <li><i className="fas fa-map-marker-alt"></i> Almaty, Kazakhstan</li>
          </ul>
        </div>
      </div>

  ...
  return (
    <div className="liked-attractions-page">
      <section className="liked-header">
        ...
        <p>{likedAttractions.length} attraction{likedAttractions.length !== 1 ? "s" : ""} saved</p>
      </section>
        ...
        {likedAttractions.length === 0 ? (
          ...
          likedAttractions.map((item) => (
            <div key={item.id} className="liked-card">
              <div className="liked-image" style={{ backgroundImage: `url(${item.image})` }}>
                <button
              ...
              <div className="liked-content">
                ...
                <div className="liked-location">
                  ...
                  <span className="location-value">{item.country.charAt(0).toUpperCase() + item.country.slice(1)}</span>
                </div>
                <div className="liked-location">
